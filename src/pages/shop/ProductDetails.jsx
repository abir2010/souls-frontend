...
const ProductDetails = () => {
  ...
  // Fetch Approved Reviews (Runs only after product is loaded)
  ...
  // Helper function to render star ratings (both for display and interactive in review form)
  ...
  // If there's an error or no product is found, show a user-friendly message
  if (isError || !product)
    return (
