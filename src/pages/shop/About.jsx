...
const About = () => {
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      <div className="relative h-[50vh] md:h-[60vh] w-full bg-brand-primary overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-gray-200 text-lg md:text-xl max-w-2xl font-medium">
            Redefining contemporary menswear from the heart of Chattogram to the
            world.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            ...
            <div className="space-y-4 text-gray-500 leading-relaxed text-sm md:text-base">
              <p>
                Founded in Chattogram, Bangladesh, Souls Lifestyle began with a
                simple observation: men shouldn't have to choose between
                traditional elegance and modern comfort.
              </p>
              <p>
                We noticed a gap in the market for premium, well-fitted Panjabis
                and casual wear that felt as good as they looked. What started
                as a small collection of custom-tailored shirts has rapidly
                evolved into a full-fledged lifestyle brand.
              </p>
              <p>
                Today, our mission remains unchanged. We create timeless pieces
                that elevate your everyday wardrobe, ensuring you walk into
                every room with quiet confidence.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* 4. Commitment to Quality Banner */}
