      ...
      <div className="bg-brand-primary py-16 md:py-24 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto text-lg">
            Experience our fabrics, check your fit, and get personalized styling
            advice at our flagship store in Chattogram.
          </p>
        </div>
      </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500">soulslifestylebd@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
